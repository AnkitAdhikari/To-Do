...
class Task {
    ...
    constructor(name, dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(new Date(), "yyyy-MM-dd"), priority = 1, note, id) {
        this.name = name;
...
new class Projects {
    ...
    todayTasks() {
        ...
        projects.forEach((project, i, _) => {
            tasks.push(project.todo.tasks.filter(task => {
                task.projectId = i;
                return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.isToday)(task.dueDate)
            }));
        })
        tasks = tasks.flat();
        PubSub.publish("Render_Tasks", { tasks });
    ...
    weekTasks() {
        ...
        projects.forEach((project, i, _) => {
            tasks.push(project.todo.tasks.filter(task => {
                task.projectId = i;
                return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.isThisWeek)(task.dueDate)
            }));
        })
        tasks = tasks.flat();
        PubSub.publish("Render_Tasks", { tasks });
